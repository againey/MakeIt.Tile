...
namespace Experilous.Topological
{
	public class FaceVerticesBuilder
	{
		...
		private void AddEdgeToVertex(ushort[] vertexNeighborCounts, int[] vertexFirstEdgeIndices, Topology.EdgeData[] edgeData, int vertex, int edge)
		{
		...
		private void PutEdgesInSequence(Topology.EdgeData[] edgeData, int edge0, int edge1)
		{
		...
		public Topology BuildTopology()
		{
			...
			var internalEdgeData = new Topology.EdgeData[_faceVertices.Count];
			...
			else
			{
				...
				// setting their twins.
				edgeData = new Topology.EdgeData[internalEdgeData.Length + boundaryEdgeCount];
